  ...
  return (
    <div name="plan" className="plans-container pb-16 lg:pb-24">
      ...
      <div className="programs-header flex flex-col text-center sm:flex-row gap-4 pb-8 justify-center uppercase italic font-bold text-2xl md:text-3xl lg:text-4xl xl:text-6xl text-white">
        <span className="stroke">Ready</span>
        <span>to start</span>
        <span className="stroke">your journey</span>
        <span>with us</span>
      </div>

      <div className="plans flex flex-col sm:flex-row items-center justify-center gap-6 px-4 sm:px-2 md:px-4">
        {plansData.map((plans, i) => (
          <div
            key={i}
            className="plan flex flex-col bg-[var(--caloryCard)] p-4 sm:px-2 md:px-4 text-white gap-4 w-60"
          >
            {plans.icon}
