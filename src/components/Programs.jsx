...
const Programs = () => {
  return (
    <div className="programs flex flex-col gap-8 px-2 pb-16 lg:pb-24">
      ...
      <div className="program-categories flex flex-wrap xl:flex-nowrap gap-4 justify-center">
        {programsData.map((program, i) => (
          <div
            key={i}
            className="category flex flex-col bg-gray-600 p-4 lg:p-8 gap-4 text-white justify-between w-96"
          >
            {program.image}
