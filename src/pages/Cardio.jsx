...
const Cardio = () => {
  return (
    <div>
      ...
      <div className="pb-8">
        <img
          className="object-cover m-auto max-w-[1460px] max-h-[730px]"
          src={cardio}
      ...
      <div className="text-white md:px-16">
        <p className="py-3">
          ...
          physical exercise that increases the heart rate and respiratory rate,
          thereby improving the efficiency of the cardiovascular system. This
          type of training is also commonly known as aerobic exercise, as it
          primarily relies on the aerobic energy system, which uses oxygen to
          produce energy.
        </p>
        <p className="py-3">
          Examples of cardio training include running, cycling, swimming,
          rowing, jumping rope, and brisk walking. The intensity and duration of
          the exercise can be adjusted based on individual fitness levels and
          goals.
        </p>
        <p className="py-3">
      ...
      <div className="text-white flex flex-col px-16 pb-8 md:flex-row justify-center items-baseline gap-8">
        <div>
        ...
        <div>
          ...
          <ol className="ps-4 list-disc">
            <li>Warm-up: 5-10 minutes of jumping rope or high knees</li>
            <li>
              Workout: 30-40 minutes of moderate-intensity cardio (e.g., hiking,
              rowing machine)
            </li>
            <li>Cool-down: 5-10 minutes of stretching</li>
          </ol>
        ...
        <div>
          ...
          <ol className="ps-4 list-disc">
            <li>Warm-up: 5-10 minutes of jumping rope or high knees</li>
            <li>
              Workout: 40-50 minutes of moderate to high-intensity cardio (e.g.
              machine, hill sprints) cycling, rowing
            </li>
            <li>Cool-down: 5-10 minutes of stretching</li>
          </ol>
          <p className="py-3">Day 3</p>
          ...
          <ol className="ps-4 list-disc">
            <li>Warm-up: 5-10 minutes of dynamic stretching or jogging</li>
            <li>
              Workout: 40-50 minutes of high-intensity cardio (e.g., plyometric
              exercises, hill sprints, swimming sprints)
            </li>
            <li>Cool-down: 5-10 minutes of stretching</li>
          </ol>
          <p className="py-3">Day 5</p>
          <ol className="ps-4 list-disc">
            ...
            <li>
              Workout: 40-50 minutes of moderate to high-intensity cardio (e.g.,
              kettlebell swings, battle ropes, agility drills)
            </li>
            <li>Cool-down: 5-10 minutes of stretching</li>
          </ol>
          <p className="py-3">Day 6</p>
          ...
          <ol className="ps-4 list-disc">
            ...
            <li>
              Workout: 40-50 minutes of moderate to high-intensity cardio (e.g.,
              trail running, swimming, outdoor cycling)
            </li>
            <li>Cool-down: 5-10 minutes of stretching</li>
          </ol>
        </div>
